...
define('DB_NAME', 'duowordpress');

/** MySQL 資料庫使用者名稱，請更改 "username_here" */
define('DB_USER', 'duowordpress');

/** MySQL 資料庫密碼，請更改 "password_here" */
define('DB_PASSWORD', 'duo_changeme');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'Qi!NUsU-+-1dhhqaa!I[to3c*foWiT*>i6Uo[QquwlpNzE80YD] :%GbPb6}+/1P');
define('SECURE_AUTH_KEY',  '&fJEM+x5tB1yd}-K?J|_w]j>E-t-f*-{Wn-|=oUc1EK<r?gcz#-OP*Z^(in]OswN');
define('LOGGED_IN_KEY',    'U<.^-k88D>W+?ze@l/$:{#~S-E+^ybDxOD~ZVPq?l.NKQjOxN}b[.oR>svR+Vn_-');
define('NONCE_KEY',        'yEH2XG%zqJ:3aaK*|lTa~Z*E^p$T|-Z%ScKF7eKnq`wuY:kTB])RtA#^lb^v-,%v');
define('AUTH_SALT',        '=|A&Hh_cU#d1X4M%oh)GRZk;ORQ|28_mC`rqu3wKj5FJ$NK)-51NY-=$<gY;80/t');
define('SECURE_AUTH_SALT', 'CG#;@oubtN~-PI|j??0-iyVepH+8|>dmi++cUBg*S@^Mq~yden(n:J2a1J}US3N[');
define('LOGGED_IN_SALT',   '/rNzXDr1+=zOHuH60F3qS-!*oYkFE![:2^&/|ooXuf}49p`E[}:Kj:(3D=Zx~DEY');
define('NONCE_SALT',       'H^jnr8!^EJ1IYr5dL3El_c~A5I2t6O.yKMreFw.HlnW+9gwLul`]Nsi53$^|UGR9');
